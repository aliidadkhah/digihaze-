export const CATEGORIES = [
  { id: "eliquid", label: "مایع ویپ", color: "#2F86FF" },
  { id: "device", label: "دستگاه ویپ", color: "#FF8A3D" },
  { id: "pod", label: "پاد و کارتریج", color: "#22E5C9" },
  { id: "accessory", label: "لوازم جانبی", color: "#C6FF3D" },
];

export const PRODUCTS = [
  {
    id: "p1",
    name: "مایع ویپ توت‌فرنگی یخی",
    category: "eliquid",
    brand: "CloudBerry",
    price: 480000,
    discount: 15,
    ...
    badge: "پرفروش",
    images: [
      "https://images.unsplash.com/photo-1626200419199-391ae4be7a41?q=80&w=800&auto=format&fit=crop",
