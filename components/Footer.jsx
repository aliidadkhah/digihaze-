...
return (
<svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: "block" }}> <path
...
<div style={{ maxWidth: 1180, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: 28 }}> <div>
<div style={{ fontFamily: "Vazirmatn", fontWeight: 800, fontSize: 20, marginBottom: 10 }}>
دیجی<span style={{ color: "#2F86FF" }}>هیز</span> </div>
<p style={{ color: "var(--text-lo)", fontSize: 13, lineHeight: 2 }}>
فروشگاه پاد، ویپ، سالت نیکوتین و لوازم جانبی با ارسال سریع و ضمانت اصالت کالا. </p>
<p style={{ color: "var(--text-mut)", fontSize: 11, marginTop: 10 }}>
فروش این محصولات صرفاً به افراد بالای ۱۸ سال مجاز است. </p> </div>
