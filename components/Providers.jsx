...
export default function Providers({ children }) {
  ...
  const cartValue = { cart, addToCart, updateQty, removeItem, count: cart.reduce((s, i) => s + i.qty, 0) };
  const userValue = { user, login: setUser, logout: () => setUser(null) };
  const themeValue = { theme, toggle: () => setTheme((t) => (t === "dark" ? "light" : "dark")) };
